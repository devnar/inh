function answer(a) {
    ...
    } else if (a.toLowerCase().substring(0, 4) == "call") {
        document.querySelector("#scriptAdd").innerHTML += "<script src='https://raw.githubusercontent.com/"+ a.substring(5) +"'></script>";
    ...
    } else if (localStorage.getItem("extension") == true) {extension(a)} else {
        if (a != "") {
